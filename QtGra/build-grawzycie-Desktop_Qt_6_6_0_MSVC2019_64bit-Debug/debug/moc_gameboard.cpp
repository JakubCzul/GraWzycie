...
struct qt_meta_stringdata_CLASSGameOfLifeBoardENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSGameOfLifeBoardENDCLASS = QtMocHelpers::stringData(
    "GameOfLifeBoard",
    "gameSaved",
    "",
    "initializeBoard",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSGameOfLifeBoardENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSGameOfLifeBoardENDCLASS_t qt_meta_stringdata_CLASSGameOfLifeBoardENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSGameOfLifeBoardENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject GameOfLifeBoard::staticMetaObject = { {
    QMetaObject::SuperData::link<QTableWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSGameOfLifeBoardENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSGameOfLifeBoardENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGameOfLifeBoardENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *GameOfLifeBoard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSGameOfLifeBoardENDCLASS.stringdata0))
